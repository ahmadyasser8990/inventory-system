                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active" >
                                        <a style="background: #8796af94;" href="{{route('dashboard.customer-statment.index')}}">@lang('site.Customer_account_statement')</a>
                                    </li>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.Customer_account_statement')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_amounts_needed')</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_amount_forSuppliers')</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.choose_account_first_then_select_report_type_then_select_dates')</div>
                                    </div>
                                    <hr>
                                    <div class="card-body pt-0" >
                                        <div class="raw">
                                            <p>@lang('site.accounts')</p>
                                        </div>

                                        <div class="raw">
                                            <!-- Checkbox all_accounts -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_all_accounts">
                                                <label class="custom-control-label" for="checkbox_all_accounts">@lang('site.all_accounts')</label>
                                            </div>
                                            <!-- Checkbox accounts_creditor -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_accounts_creditor">
                                                <label class="custom-control-label" for="checkbox_accounts_creditor">@lang('site.accounts_creditor')</label>
                                            </div>
                                            <!-- Checkbox last accounts_debtor -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_accounts_debtor">
                                                <label class="custom-control-label" for="checkbox_accounts_debtor">@lang('site.accounts_debtor')</label>
                                            </div>
                                            <!-- Checkbox selected_accounts -->
                                            <div class="form-inline">
                                                <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                                    <input type="checkbox" class="custom-control-input" id="checkbox_selected_accounts">
                                                    <label class="custom-control-label" for="checkbox_selected_accounts">@lang('site.selected_accounts')</label>
                                                </div>
                                                <input type="number" class="form-control mb-2 mr-sm-2" id="inlineFormInputName2" placeholder="@lang('site.account')">
                                        ...
                                        <hr>
                                        <div class="raw">
                                            <p>@lang('site.statment_type')</p>
                                        </div>

                                        <!-- Checkbox select_type -->
                                        <div class="form-inline">
                                            <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                                <input class="custom-control-input" type="checkbox" id="checkbox_select_type">
                                                <label class="custom-control-label" for="checkbox_select_type">
                                                     @lang('site.select_type')
                                                </label>
                                                <select class="custom-select mb-2 mr-sm-2" id="inlineFormCustomSelectPref">
                                                    <option selected>Choose...</option>
                                                    <option value="1">@lang('site.basic_statment')</option>
                                                    <option value="2">@lang('site.details_statment')</option>
                                                </select>
                                            </div>

                                            <div class="form-check custom-control custom-radio  mb-2 mr-sm-2">
                                                <input class="custom-control-input" type="checkbox" id="checkbox_show_all_in_one_page">
                                                <label class="custom-control-label" for="checkbox_show_all_in_one_page">
                                                     @lang('site.show_all_in_one_page')
                                                </label>
                                            </div>
                                            <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                                <input class="custom-control-input" type="checkbox" id="checkbox_show_each_account_in_different_page">
                                                <label class="custom-control-label" for="checkbox_show_each_account_in_different_page">
                                                     @lang('site.show_each_account_in_different_page')
                                                </label>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <!-- Checkbox select_date_between -->
                                        <div class="form-inline">
                                            <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                                <input class="custom-control-input" type="checkbox" id="checkbox_select_date_between">
                                                <label class="custom-control-label" for="checkbox_select_date_between">
                                                     @lang('site.select_date_between')
                                                </label>
                                            </div>
