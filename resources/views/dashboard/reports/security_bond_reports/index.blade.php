                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a style="background: #8796af94;" href="{{route('dashboard.security-bond-report.index')}}">@lang('site.security_bond_report') </a>
                                    </li>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.security_bond_report')</li>
                </ol>
            </div>
            <!-- Page header end -->
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_amount_secure')</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.security_bond_report')</div>
                                    </div>
                                    <hr>
