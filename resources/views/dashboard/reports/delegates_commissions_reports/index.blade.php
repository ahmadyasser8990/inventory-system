                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active" >
                                        <a style="background: #8796af94;" href="{{route('dashboard.delegates-commissions-report.index')}}">@lang('site.delegates_commissions_report')</a>
                                    </li>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.delegates_commissions_report')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_amount_commission')</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.select_employee_then_select_invoices_after_that_select_date_then_print')</div>
                                    </div>
                                    <hr>
                                    <div class="card-body pt-0" >
                                        <div class="raw">
                                            <p>@lang('site.select_employee')</p>
                                        </div>

                                        <div class="raw">
                                            <!-- Checkbox selected_account -->
                                            <div class="form-inline">
                                                <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                                    <input type="checkbox" class="custom-control-input" id="checkbox_selected_account">
                                                    <label class="custom-control-label" for="checkbox_selected_account">@lang('site.selected_account')</label>
                                                </div>
