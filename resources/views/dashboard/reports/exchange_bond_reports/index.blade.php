                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a style="background: #8796af94;"  href="{{route('dashboard.exchange-bond-report.index')}}">@lang('site.exchange_bond_report')</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.exchange_bond_report')</li>
                </ol>
            </div>
            <!-- Page header end -->
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.exchange_bond_report')</div>
                                    </div>
                                    <hr>
                                    <div class="card-body pt-0" >
                                        ...
                                        <div class="raw">
                                            ...
                                            <div class="form-inline">
                                                <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                                    <input type="checkbox" class="custom-control-input" id="checkbox_general_report">
                                                    <label class="custom-control-label" for="checkbox_general_report">@lang('site.expenses_Imports_report')</label>
                                                </div>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-inline">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label mb-2 mr-sm-2" for="defaultCheck1">
                                                    @lang('site.expenses_report')
                                                </label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input mb-2 mr-sm-2" type="checkbox" value="" id="defaultCheck1">
                                                <label class="form-check-label mb-2 mr-sm-2" for="defaultCheck1">
                                                    @lang('site.import_report')
                                                </label>
                                            </div>
                                        </div>
                                        <hr>
