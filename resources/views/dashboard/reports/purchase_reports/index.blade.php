                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a style="background: #8796af94;" href="{{route('dashboard.purchase-report.index')}}">@lang('site.purchases_report') </a>
                                    </li>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.purchases_report')</li>
                </ol>
            </div>
            <!-- Page header end -->
                            ...
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_amount_purchase')</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_items_purchase')</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-6">
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.return_security_bond_report')</div>
                                    </div>
                                    <hr>
                                    <div class="card-body pt-0" >
                                        <div class="raw">
                                            <p>@lang('site.purchases_report')</p>
                                        </div>
