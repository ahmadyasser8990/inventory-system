                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a style="background: #8796af94;" href="{{route('dashboard.offer-doc-report.index')}}">@lang('site.offer_document_report') </a>
                                    </li>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.offer_document_report')</li>
                </ol>
            </div>
            <!-- Page header end -->
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.offer_document_report')</div>
                                    </div>
                                    <hr>
                                    <div class="card-body pt-0" >
                                        ...
                                        <div class="form-inline">
                                            <div class="form-check mb-2">
                                                ...
                                                <label class="form-check-label mb-2 mr-sm-2" for="defaultCheck1">
                                                    @lang('site.sold_items')
                                                </label>
                                            </div>
                                            <div class="form-check mb-2">
                                                <input class="form-check-input mb-2 mr-sm-2" type="checkbox" value="" id="defaultCheck1">
                                                <label class="form-check-label mb-2 mr-sm-2" for="defaultCheck1">
                                                    @lang('site.remain_items')
                                                </label>
                                            </div>
                                        </div>
                                        <hr>
                                        ...
                                        <div class="form-inline">
                                            <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                                <input class="custom-control-input" type="checkbox" id="checkbox_all_data">
                                                <label class="custom-control-label" for="checkbox_all_data">
                                                     @lang('site.all_date')
                                                </label>
                                            </div>
                                        </div>
