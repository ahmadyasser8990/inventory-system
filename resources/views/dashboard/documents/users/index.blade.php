                                    ...
                                    <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-8">
                                        <div class="documents-container">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addNewContactLabel">@lang('site.add_new_user')</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form class="" action="{{route('dashboard.users.store')}}" method="post" enctype="multipart/form-data">
                                                            ...
                                                            <div class="modal-body row gutters">
                                                                ...
                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                    <div class="upload-photo-container">
                                                                        <img src="{{asset('uploads/user_images/default.png')}}" class="user-thumb image-preview" />
                                                                        <div class="form-group m-2">
                                                                            <div class="input-group">
                                                                                <div class="custom-file">
                                                                                    <input type="file" name="image" class="custom-file-input image" id="uploadPhoto">
                                                                ...
                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label for="phoneNumber">@lang('site.phone_no')</label>
                                                                    ...
                                                                    <div class="accordion" id="withIconsAccordion">
                                                                        <div class="accordion-container">
                                                                            ...
                                                                            @php
                                                                                ...
                                                                                $models = ['users','categories','products','clients', 'orders','suppliers'];

                                                                            @endphp

                                                                            @foreach ($models as $index=>$model )
                                                                                <div class="accordion-header" id="withIconOne">
                                                                                    <a  href="" class="collapsed" data-toggle="collapse" data-target="#{{$model}}" aria-expanded="false" aria-controls="{{$model}}">
                                                                                        <i class="icon icon-shield1"></i>@lang('site.' .$model)
                                                                                    </a>
                                                                                </div>

                                                                                <div id="{{$model}}" class="collapse" aria-labelledby="withIconOne" data-parent="#withIconsAccordion">
                                                                                    <div class="accordion-body">
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="create_{{$model}}" name="permissions[]" value="create_{{$model}}">
                                                                                            <label class="custom-control-label" for="create_{{$model}}"> @lang('site.create')</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="read_{{$model}}" name="permissions[]" value="read_{{$model}}">
                                                                                            <label class="custom-control-label" for="read_{{$model}}"> @lang('site.read')</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="update_{{$model}}" name="permissions[]" value="update_{{$model}}">
                                                                                            <label class="custom-control-label" for="update_{{$model}}"> @lang('site.update')</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="delete_{{$model}}" name="permissions[]" value="delete_{{$model}}">
                                                                                            <label class="custom-control-label" for="delete_{{$model}}"> @lang('site.delete')</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            ...
                                                                            {{-- @foreach ($models as $index=>$model )
                                                                                <div id="{{$model}}" class="collapse show" aria-labelledby="withIconOne" data-parent="#withIconsAccordion">
                                                                                    <div class="accordion-body">
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="create_users" name="permissions[]" value="create_users">
                                                                                            <label class="custom-control-label" for="create_users"> @lang('site.create')</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="read_users" name="permissions[]" value="read_users">
                                                                                            <label class="custom-control-label" for="read_users"> @lang('site.read')</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="update_users" name="permissions[]" value="update_users">
                                                                                            <label class="custom-control-label" for="update_users"> @lang('site.update')</label>
                                                                                        </div>
                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                            <input type="checkbox" class="custom-control-input" id="delete_users" name="permissions[]" value="delete_users">
                                                                                            <label class="custom-control-label" for="delete_users"> @lang('site.delete')</label>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            @endforeach --}}
                                                            ...
                                                            <div class="modal-footer custom">
                                                                ...
                                                                <div class="right-side">
                                                                    <button type="submit" class="btn btn-link success btn-block">@lang('site.save')</button>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="documents-header">
                                                <h3>@lang('site.users_folder')<span class="date" id="todays-date-arabic"></span></h3>

                                                @if (auth()->user()->hasPermission('create_users'))
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addNewContact">@lang('site.add_new_user')</button>
                                                @endif
                                                ...
                                                <div class="documents-body">
                                                                ...
                                                                <div class="row gutters">
                                                                    <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <span id="filter-count"> مجموع المستخدمين = {{$users->count()}}</span>
                                                    ...
                                                    <div class="row gutters">
                                                        ...
                                                        @foreach ($users as $user)
                                                            ...
                                                            <div class="search col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                                                <figure class="user-card">
                                                                    <figcaption>
                                                                        @if (auth()->user()->hasPermission('update_users'))
                                                                            <a href="#" class="edit-card" data-toggle="modal" data-target="#editContact{{$user->id}}">
                                                                                <i class="icon-mode_edit"></i>
                                                                            </a>
                                                                        @endif
                                                                        <img src="{{$user->image_path}}" class="profile">
                                                            ...
                                                            <!-- Modal edit users -->
                                                            <div class="modal fade" id="editContact{{$user->id}}" tabindex="-1" role="dialog" aria-labelledby="editContactLabel" aria-hidden="true">
                                                                <div class="modal-dialog" role="document">
                                                                    <div class="modal-content">
                                                                        <div class="modal-header">
                                                                            <h5 class="modal-title" id="editContactLabel">@lang('site.edit_user')</h5>
                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                <span aria-hidden="true">&times;</span>
                                                                            </button>
                                                                        </div>
                                                                        ...
                                                                        <form action="{{route('dashboard.users.update', $user->id)}}" method="post" enctype="multipart/form-data">
                                                                            ...
                                                                            <div class="modal-body row gutters">
                                                                                ...
                                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                                    <div class="upload-photo-container">
                                                                                        <img src="{{$user->image_path}}" class="user-thumb image-preview" />
                                                                                        <div class="form-group m-2">
                                                                                            <div class="input-group">
                                                                                                <div class="custom-file">
                                                                                                    <input type="file" name="image" class="custom-file-input image" id="uploadPhoto">
                                                                                                    <label class="custom-file-label tasks-overflow" for="uploadPhoto" aria-describedby="uploadPhotoAddon">{{$user->image}}</label>
                                                                                                </div>
                                                                                            </div>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label for="phoneNumber">@lang('site.phone_no')</label>
                                                                                        <input type="text" class="form-control" id="phoneNumber" value="{{$user->phone}}">
                                                                                    </div>
                                                                                ...
                                                                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                                    ...
                                                                                    <div class="accordion" id="withIconsAccordion">
                                                                                        <div class="accordion-container">
                                                                                            ...
                                                                                            $model_edits = ['users','categories','products','clients', 'orders','suppliers'];

                                                                                            @endphp

                                                                                            @foreach ($model_edits as $index=>$model_edit )
                                                                                                <div class="accordion-header" id="withIconOne">
                                                                                                    <a  href="" class="collapsed" data-toggle="collapse" data-target="#{{$model_edit}}" aria-expanded="false" aria-controls="{{$model_edit}}">
                                                                                                        <i class="icon icon-shield1"></i>@lang('site.' .$model_edit)
                                                                                                    </a>
                                                                                                </div>

                                                                                                <div id="{{$model_edit}}" class="collapse" aria-labelledby="withIconOne" data-parent="#withIconsAccordion">
                                                                                                    <div class="accordion-body">
                                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                                            <input type="checkbox" class="form-check-input" id="create_{{$model_edit}}" name="permissions[]" {{ $user->hasPermission('create_' . $model_edit) ? 'checked' : ''}} value="create_{{$model_edit}}">
                                                                                                            <label class="form-check-label" for="create_{{$model_edit}}"> @lang('site.create')</label>
                                                                                                        </div>
                                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                                            <input type="checkbox" class="form-check-input" id="read_{{$model_edit}}" name="permissions[]" {{ $user->hasPermission('read_' . $model_edit) ? 'checked' : ''}} value="read_{{$model_edit}}">
                                                                                                            <label class="form-check-label" for="read_{{$model_edit}}"> @lang('site.read')</label>
                                                                                                        </div>
                                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                                            <input type="checkbox" class="form-check-input" id="update_{{$model_edit}}" name="permissions[]" {{ $user->hasPermission('update_' . $model_edit) ? 'checked' : ''}} value="update_{{$model_edit}}">
                                                                                                            <label class="form-check-label" for="update_{{$model_edit}}"> @lang('site.update')</label>
                                                                                                        </div>
                                                                                                        <div class="custom-control custom-checkbox custom-control-inline">
                                                                                                            <input type="checkbox" class="form-check-input" id="delete_{{$model_edit}}" name="permissions[]" {{ $user->hasPermission('delete_' . $model_edit) ? 'checked' : ''}} value="delete_{{$model_edit}}">
                                                                                                            <label class="form-check-label" for="delete_{{$model_edit}}"> @lang('site.delete')</label>
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
...
<script>
    ...
    $("#filter").keyup(function(){
        ...
        $("#filter-count").text("مجموع السمتخدمين  = "+count);
