                                            ...
                                            <div class="docTypeContainerScroll">
                                                <div class="docs-block">
                                                    ...
                                                    <div class="doc-labels">
                                                        ...
                                                        <a href="{{route('dashboard.taxes.index')}}" class="active">
                                    ...
                                    <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-8">
                                        <div class="documents-container">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addNewDocumentLabel">@lang('site.add_new_tax')</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form class="" action="{{route('dashboard.taxes.store')}}" method="post">
                                                            {{ csrf_field() }}
                                                            {{ method_field('post')}}
                                                            ...
                                                            <div class="modal-body row gutters">
                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                    <div class="form-group">
                                                                        <label for="docTitle">@lang('site.taxes_no')</label>
                                                                        <input type="number" name="tax_no" class="form-control" id="docTitle" placeholder="@lang('site.taxes_no')">
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                    <div class="form-group">
                                                                        <label for="addedDate">@lang('site.tax_name')</label>
                                                                        <div class="custom-date-input">
                                                                            <input type="text" name="name" class="form-control datepicker" id="addedDate" placeholder="@lang('site.tax_name')">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                    <div class="form-group">
                                                                        <label for="addedDate">@lang('site.percentage_tax')</label>
                                                                        <div class="custom-date-input">
                                                                            <input type="number" name="precentage" class="form-control datepicker" id="addedDate" placeholder="@lang('site.percentage_tax')">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="documents-header">
                                                <h3>@lang('site.taxes_folder')<span class="date" id="todays-date-arabic"></span></h3>
                                                <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addNewDocument">@lang('site.add_new_tax')</button>
                                            </div>
                                            <div class="documentsContainerScroll">
                                                <div class="documents-body">

                                                    @include('partials._errors')
                                                        <form action="{{route('dashboard.taxes.index')}}" method="get">
                                                            <div class="row gutters">
                                                                <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span id="filter-count"> مجموع العمولات = {{$taxes->count()}}</span>
                                                            ...
                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                ...
                                                                <div class="table-responsive">
                                                                    ...
                                                                    <table class="table projects-table">
                                                                        <thead>
                                                                            <tr>
                                                                                <th>@lang('site.taxes_no')</th>
                                                                                <th>@lang('site.tax_name')</th>
                                                                                <th>@lang('site.percentage_tax')</th>
                                                                        ...
                                                                        <tbody>
                                                                            ...
                                                                            <tr class="search">
                                                                                <td>{{$tax->tax_no}}</td>
                                                                                <td>{{$tax->name}}</td>
                                                                                <td>{{$tax->precentage}} %</td>
                                                                                <td>
                                                                                    <div class="custom-btn-group">
                                                                                        <button type="button" data-toggle="modal" data-target="#editDocument{{$tax->id}}" title="@lang('site.edit')" class="btn btn-success btn-rounded">@lang('site.edit')<span class="icon-pencil" ></span></button>
                                                                                        <form action="{{route('dashboard.taxes.destroy',$tax->id)}}" method="post" style="display: inline-block">
                                                                                            {{csrf_field()}}
                                                                                            {{ method_field('delete')}}
                                                                            ...
                                                                            {{-- modal edit tax --}}
                                                                            <div class="modal fade" id="editDocument{{$tax->id}}" tabindex="-1" role="dialog" aria-labelledby="editDocumentLabel" aria-hidden="true">
                                                                                <div class="modal-dialog" role="document">
                                                                                    <div class="modal-content">
                                                                                        <div class="modal-header">
                                                                                            <h5 class="modal-title" id="editDocumentLabel">@lang('site.edit_tax')</h5>
                                                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                                <span aria-hidden="true">&times;</span>
                                                                                            </button>
                                                                                        </div>
                                                                                        <form class="" action="{{route('dashboard.taxes.update', $tax->id)}}" method="post">
                                                                                            {{ csrf_field() }}
                                                                                            {{ method_field('put')}}
                                                                                            ...
                                                                                            <div class="modal-body row gutters">
                                                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                                    <div class="form-group">
                                                                                                        <label for="docTitle">@lang('site.taxes_no')</label>
                                                                                                        <input type="number" name="tax_no" class="form-control" id="docTitle"  value="{{$tax->tax_no}}" placeholder="@lang('site.taxes_no')">
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                                    <div class="form-group">
                                                                                                        <label for="addedDate">@lang('site.tax_name')</label>
                                                                                                        <div class="custom-date-input">
                                                                                                            <input type="text" name="name" class="form-control datepicker" id="addedDate" value="{{$tax->name}}" placeholder="@lang('site.tax_name')">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                                    <div class="form-group">
                                                                                                        <label for="addedDate">@lang('site.percentage_tax')</label>
                                                                                                        <div class="custom-date-input">
                                                                                                            <input type="number" name="precentage" class="form-control datepicker" id="addedDate" value="{{$tax->precentage}}" placeholder="@lang('site.percentage_tax')">
                                                                                                        </div>
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
...
<script>
    ...
    $("#filter").keyup(function(){
        ...
        $("#filter-count").text("مجموع العمولات = "+count);
