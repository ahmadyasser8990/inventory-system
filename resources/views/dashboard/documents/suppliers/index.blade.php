                                            ...
                                            <div class="docTypeContainerScroll">
                                                <div class="docs-block">
                                                    ...
                                                    <div class="doc-labels">
                                                        ...
                                                        <a href="{{route('dashboard.suppliers.index')}}" class="active">
                                    ...
                                    <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-8">
                                        <div class="documents-container">
                                                ...
                                                <div class="modal-dialog" role="document">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="addNewContactLabel">@lang('site.add_new_supplier')</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">&times;</span>
                                                            </button>
                                                        </div>
                                                        <form class="" action="{{route('dashboard.suppliers.store')}}" method="post">
                                                            {{ csrf_field() }}
                                                            {{ method_field('post')}}
                                                            ...
                                                            <div class="modal-body row gutters">
                                                                ...
                                                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="number" name="commercial_register" class="form-control">
                                                                    </div>
                                                                </div>
                                                            </div>
                                            ...
                                            <div class="documents-header">
                                                <h3>@lang('site.suppliers_folder')<span class="date" id="todays-date-arabic"></span></h3>
                                                @if (auth()->user()->hasPermission('create_suppliers'))
                                                    <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addNewContact">@lang('site.add_new_supplier')</button>
                                                @endif
                                                            ...
                                                            <div class="row gutters">
                                                                <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span id="filter-count"> مجموع الموردين = {{$suppliers->count()}}</span>
                                                            ...
                                                            @foreach ($suppliers as $supplier)
                                                                ...
                                                                <div class="search col-xl-3 col-lg-4 col-md-6 col-sm-6 col-12">
                                                                    <figure class="user-card">
                                                                        <figcaption>
                                                                            <a href="#" class="edit-card" data-toggle="modal" data-target="#editContact{{$supplier->id}}">
                                                                                <i class="icon-mode_edit"></i>
                                                                            </a>
                                                                            <h5>{{$supplier->name}}</h5>
                                                                            <ul class="list-group">
                                                                                <li class="list-group-item">@lang('site.supplier_id') {{$supplier->id}} </li>
                                                                                <li class="list-group-item">@lang('site.tax_no') {{$supplier->tax_no}} </li>
                                                                                <li class="list-group-item">@lang('site.commercial_register') {{$supplier->commercial_register}} </li>
                                                                                <li class="list-group-item">@lang('site.phone_no') {{$supplier->phone}} </li>
                                                                ...
                                                                <!-- Edit Contact Modal -->
                                                                <div class="modal fade" id="editContact{{$supplier->id}}" tabindex="-1" role="dialog" aria-labelledby="editContactLabel" aria-hidden="true">
                                                                    <div class="modal-dialog" role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <h5 class="modal-title" id="editContactLabel">@lang('site.edit_supplier')</h5>
                                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                    <span aria-hidden="true">&times;</span>
                                                                                </button>
                                                                            </div>

                                                                            <form class="" action="{{route('dashboard.suppliers.update',$supplier->id)}}" method="post">
                                                                                {{ csrf_field() }}
                                                                                {{ method_field('put')}}
                                                                                <div class="modal-body row gutters">
                                                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                        <div class="form-group">
                                                                                            <label for="contactName">@lang('site.full_name')</label>
                                                                                            <input type="text" name="name" class="form-control" id="contactName" value="{{$supplier->name}}">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                        <div class="form-group">
                                                                                            <label for="phoneNumber">@lang('site.phone_no')</label>
                                                                                            <input type="number" name="phone" class="form-control" id="phoneNumber" value="{{$supplier->phone}}">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                        <div class="form-group">
                                                                                            <label>@lang('site.tax_no')</label>
                                                                                            <input type="number" name="tax_no" value="{{$supplier->tax_no}}" class="form-control">
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                        <div class="form-group">
                                                                                            <label>@lang('site.commercial_register')</label>
                                                                                            <input type="number" name="commercial_register" value="{{$supplier->commercial_register}}" class="form-control">
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                                <div class="modal-footer custom">
