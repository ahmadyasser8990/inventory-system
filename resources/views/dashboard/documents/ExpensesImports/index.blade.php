                                                ...
                                                <div class="docTypeContainerScroll">
                                                    <div class="docs-block">
                                                        ...
                                                        <div class="doc-labels">
                                                            ...
                                                            <a href="{{route('dashboard.expensesimports.index')}}" class="active">
                                        ...
                                        <div class="col-xl-10 col-lg-10 col-md-9 col-sm-9 col-8">
                                            <div class="documents-container">
                                                    ...
                                                    <div class="modal-dialog" role="document">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h5 class="modal-title" id="addNewDocumentLabel">@lang('site.add_new_expenses_and_imports')</h5>
                                                                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                            </div>
                                                            <form class="" action="{{route('dashboard.expensesimports.store')}}" method="post">
                                                                {{ csrf_field() }}
                                                                {{ method_field('post')}}
                                                                ...
                                                                <div class="modal-body row gutters">
                                                                        ...
                                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                            <div class="form-group">
                                                                                <label for="docTitle">@lang('site.expenses_name_or_import_name')</label>
                                                                                <input type="text" name="name" class="form-control" id="docTitle" placeholder="@lang('site.expenses_name_or_import_name')">
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                            <div class="form-group">
                                                                                <label for="docTitle">@lang('site.type')</label>
                                                                                <select class="form-control form-control-lg" name="type">
                                                                                    <option >@lang('site.type')</option>
                                                                                    <option value="مصاريف">@lang('site.expenses')</option>
                                                                                    <option value="وارد">@lang('site.import')</option>
                                                                                </select>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                            <div class="form-group">
                                                                                <label for="addedDate">@lang('site.amount')</label>
                                                                                <div class="custom-date-input">
                                                                                    <input type="number" name="amount" class="form-control datepicker" id="addedDate" placeholder="@lang('site.amount')">
                                                                                </div>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                            <div class="form-group mb-0">
                                                                                <label for="docDetails">@lang('site.notes')</label>
                                                                                <textarea class="form-control" name="note" id="docDetails"></textarea>
                                                                            </div>
                                                                        </div>
                                                                </div>
                                                ...
                                                <div class="documents-header">
                                                    <h3>@lang('site.expenses_and_imports_folder') <span class="date" id="todays-date-arabic"></span></h3>
                                                    <button class="btn btn-primary btn-lg" data-toggle="modal" data-target="#addNewDocument">@lang('site.add_new_expenses_and_imports')</button>
                                                </div>
                                                <div class="documentsContainerScroll">
                                                    <div class="documents-body">
                                                            ...
                                                            <div class="row gutters">
                                                                <div class="col-xl-4 col-lglg-4 col-md-4 col-sm-4 col-12">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <span id="filter-count"> مجموع المصاريف والواردات = {{$expenseimports->count()}}</span>
                                                        ...
                                                        <div class="row no-gutters justify-content-center">
                                                            @if ($expenseimports->count() > 0)
                                                                @foreach ($expenseimports as $expenseimport)
                                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">

                                                                        <section class="task-list search">

                                                                            <!-- Task #1 -->
                                                                            <div class="task-block">
                                                                                <div class="task-details">
                                                                                    <div class="task-name">{{$expenseimport->name}}</div>
                                                                                    <div class="task-desc">{!!$expenseimport->note!!}</div>
                                                                                    <div class="task-types">
                                                                                        @if ($expenseimport->type == "مصاريف")
                                                                                            <span class="badge badge-danger">{{$expenseimport->type}}</span>
                                                                                            <span class="badge badge-danger"> {{$expenseimport->amount}} @lang('site.riyal')</span>
                                                                                        @else
                                                                                            <span class="badge badge-success">{{$expenseimport->type}}</span>
                                                                                            <span class="badge badge-success"> {{$expenseimport->amount}} @lang('site.riyal')</span>
                                                                                        @endif
                                                                                ...
                                                                                <ul class="task-actions">
                                                                                    ...
                                                                                    <li class="dropdown">
                                                                                        ...
                                                                                        <div class="dropdown-menu" aria-labelledby="task-actions">
                                                                                            <form action="{{route('dashboard.expensesimports.destroy',$expenseimport->id)}}" method="post" style="display: inline-block">
                                                                                                {{csrf_field()}}
                                                                                                {{ method_field('delete')}}
                                                                                                    <input type="hidden" value="{{$expenseimport->id}}">
                                                                                                <button type="submit" class="btn btn-dark delete " title="@lang('site.delete')"><span class="icon-delete"></span></span> @lang('site.delete')</button>
                                                                                            </form>
                                                                                            <a href="#" data-toggle="modal" data-target="#editDocument{{$expenseimport->id}}" style="display: inline-block;">
                                                                                                <i class="icon-mode_edit"></i> @lang('site.edit')
                                                                                            </a>
                                                                                        </div>
                                                                                    </li>
                                                                                </ul>
                                                                    ...
                                                                    {{-- modal edit --}}
                                                                    <div class="modal fade" id="editDocument{{$expenseimport->id}}" tabindex="-1" role="dialog" aria-labelledby="editDocumentLabel" aria-hidden="true">
                                                                        <div class="modal-dialog" role="document">
                                                                            <div class="modal-content">
                                                                                <div class="modal-header">
                                                                                    <h5 class="modal-title" id="editDocumentLabel">@lang('site.edit_expenses_and_imports')</h5>
                                                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                                        <span aria-hidden="true">&times;</span>
                                                                                    </button>
                                                                                </div>
                                                                                <form class="" action="{{route('dashboard.expensesimports.update', $expenseimport->id )}}" method="post">
                                                                                    {{ csrf_field() }}
                                                                                    {{ method_field('put')}}

                                                                                    <div class="modal-body row gutters">
                                                                                        <input type="hidden" name="id" class="form-control" id="docTitle" value="{{$expenseimport->id}}">

                                                                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                                <div class="form-group">
                                                                                                    <label for="docTitle">@lang('site.expenses_name_or_import_name')</label>
                                                                                                    <input type="text" name="name" class="form-control" id="docTitle" value="{{$expenseimport->name}}" placeholder="@lang('site.expenses_name_or_import_name')">
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                                <div class="form-group">
                                                                                                    ...
                                                                                                    <select class="form-control form-control-lg" name="type">
                                                                                                        <option >@lang('site.type')</option>
                                                                                                        @if ($expenseimport->type == "مصاريف")
                                                                                                            <option value="مصاريف" selected>@lang('site.expenses')</option>
                                                                                                            <option value="وارد">@lang('site.import')</option>
                                                                                                        @else
                                                                                                            <option value="مصاريف" >@lang('site.expenses')</option>
                                                                                                            <option value="وارد" selected>@lang('site.import')</option>
                                                                                                        @endif
                                                                                            ...
                                                                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                                                                <div class="form-group">
                                                                                                    <label for="addedDate">@lang('site.amount')</label>
                                                                                                    <div class="custom-date-input">
                                                                                                        <input type="number" name="amount" value="{{$expenseimport->amount}}" class="form-control" id="addedDate" placeholder="@lang('site.amount')">
                                                                                                    </div>
                                                                                                </div>
                                                                                            </div>
                                                                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                                                                <div class="form-group mb-0">
                                                                                                    <label for="docDetails">@lang('site.notes')</label>
                                                                                                    <textarea class="form-control " name="note" id="docDetails">{!!$expenseimport->note!!}</textarea>
                                                                                                </div>
                                                                                            </div>
                                                                                    </div>
                                                                                    <div class="modal-footer custom">
...
<script>
    ...
    $("#filter").keyup(function(){
        ...
        $("#filter-count").text("مجموع المصاريف والواردات = "+count);
