                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu ">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a style="background: #8796af94;" href="{{route('dashboard.catch-receipt.index')}}">@lang('site.catch_receipt')</a>
                                    </li>
                                    <li>
            ...
            <div class="main-container">
                ...
                <div class="row justify-content-center gutters">
                    <div class="col-xl-10 col-lg-10 col-md-12 col-sm-12 col-12">
                        <form action="{{route('dashboard.catch-receipt.store')}}" method="POST">
                            {{ csrf_field() }}
                            {{ method_field('post')}}
                                    ...
                                    <div class="row gutters">
                                        <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" readonly value="{{$nextCatchReceiptId}}">
                                            </div>
                                        </div>
                                    </div>
                                    <!-- Row start -->
