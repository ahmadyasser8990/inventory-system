        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.deposit_doc')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row grutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-left mb-3">
                                    <!-- Button add new sale -->
                                    <a href="{{route('dashboard.deposit-doc.create')}}" class="btn btn-primary">@lang('site.new_deposit_doc')</a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-light table-sm">
                                        <thead>
                                            <tr>
                                                <th>@lang('site.deposit_doc_no')</th>
                                        ...
                                        <tbody>
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.deposit_doc_info')</h5>
                                                        ...
                                                        <form class="" action="" method="" enctype="">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.deposit_doc_no')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="number" class="form-control" placeholder="@lang('site.deposit_doc_no')">
                                                                    </div>
                                                                ...
                                                                <hr>
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.customer_name')</label>
                                                                    <div class="col-sm-4">
                                                                        <input type="number" name="customer_name" class="form-control" placeholder="@lang('site.customer_name')">
                                                                    </div>
                                                                ...
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.for_what')</label>
                                                                    <div class="col-sm-4">
                                                                        <input type="number" class="form-control" placeholder="@lang('site.for_what')">
                                                                    </div>
                                                                ...
                                                                <div class="form-group row gutters">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        <textarea type="number" class="form-control" placeholder="@lang('site.note')"></textarea>
                                                                    </div>
                                                                ...
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-8 col-form-label text-right">@lang('site.remain')</label>
                                                                    <div class="col-sm-2">
                                            ...
                                            <div class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.deposit_doc_edit')</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                        </div>
