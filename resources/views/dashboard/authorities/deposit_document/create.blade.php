        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">@lang('site.deposit_doc')</li>
                        ...
                        <form>
                            <div class="card m-0">
                                <div class="card-header">
                                    <div class="card-title">@lang('site.deposit_doc')</div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row gutters">
                                        <div class="col-xl-12">
                                            ...
                                            <a href="{{route('dashboard.deposit-doc.index')}}" class="btn btn-danger float-right">@lang('site.close')</a>
                                        </div>
                                    </div>
                                    <!-- Row end -->
