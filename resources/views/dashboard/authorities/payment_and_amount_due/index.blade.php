        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.payments_and_amounts_due')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row gutters">
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_payments_due')</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>1200</h3>
                                        <p>@lang('site.total_payments_late')</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>12</h3>
                                        <p>@lang('site.total_payments_upcoming')</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>50</h3>
                                        <p>@lang('site.total_payments_paid')</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.payments_and_amounts_due') (@lang('site.print_invoices_by_client_id_or_client_name_or_invoice_no'))</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="raw">
                                            <!-- Checkbox Payment Due -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_show_payments_due">
                                                <label class="custom-control-label" for="checkbox_show_payments_due">@lang('site.show_payments_due')</label>
                                            </div>
                                            <!-- Checkbox Payment late -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_show_payments_late">
                                                <label class="custom-control-label" for="checkbox_show_payments_late">@lang('site.show_payments_late')</label>
                                            </div>
                                            <!-- Checkbox last Payment upcoming -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_show_payments_upcoming">
                                                <label class="custom-control-label" for="checkbox_show_payments_upcoming">@lang('site.show_payments_upcoming')</label>
                                            </div>
                                            <!-- Checkbox Payment paid -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_show_payments_paid">
                                                <label class="custom-control-label" for="checkbox_show_payments_paid">@lang('site.show_payments_paid')</label>
                                            </div>
                                            <!-- Checkbox select Inoice No or Client ID or Client Name -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_search">
                                                <label class="custom-control-label" for="checkbox_search">@lang('site.search')</label>
                                            </div>
                                        </div>
                                        <div class="row gutters pt-2">
                                            ...
                                            <button type="button" class="btn btn-primary">@lang('site.search')</button>
                                        </div>
                                        <div class="row gutters pt-2">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
