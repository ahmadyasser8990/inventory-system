        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.adding_amount_to_capital')</li>
                </ol>
            </div>
            <!-- Page header end -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        ...
                                        <p>@lang('site.adding_amount_to_capital')</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row grutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-left mb-3">
                                    <!-- Button add new sale -->
                                    <a href="{{route('dashboard.adding-money-to-capital.create')}}" class="btn btn-primary">@lang('site.new_adding_amount_to_capital')</a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-light table-sm">
                                        <thead>
                                            <tr>
                                                <th>@lang('site.adding_amount_to_capital_no')</th>
                                        ...
                                        <tbody>
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.adding_amount_to_capital_info')</h5>
                                            ...
                                            <div class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.adding_amount_to_capital_edit')</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                        </div>
