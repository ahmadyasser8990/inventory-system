        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.maintenance_doc')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row grutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-left mb-3">
                                    <!-- Button add new sale -->
                                    <a href="{{route('dashboard.maintenance-doc.create')}}" class="btn btn-primary">@lang('site.new_maintenance_doc')</a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-light table-sm">
                                        <thead>
                                            <tr>
                                                <th>@lang('site.maintenance_doc_no')</th>
                                                <th>@lang('site.applicant')</th>
                                                <th>@lang('site.phone')</th>
                                                <th>@lang('site.item_type')</th>
                                                <th>@lang('site.required')</th>
                                                <th>@lang('site.amount')</th>
                                                <th>@lang('site.paid')</th>
                                                <th>@lang('site.remain')</th>
                                        ...
                                        <tbody>
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.maintenance_doc_info')</h5>
                                                        ...
                                                        <form class="" action="" method="" enctype="">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.maintenance_doc_no')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="number" class="form-control" placeholder="@lang('site.maintenance_doc_no')">
                                                                    </div>
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.status_doc')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="text" class="form-control" placeholder="@lang('site.status_doc')">
                                                                    </div>
                                                                ...
                                                                <hr>
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.applicant')</label>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" class="form-control" placeholder="@lang('site.applicant')">
                                                                    </div>
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.phone')</label>
                                                                    <div class="col-sm-2">
                                                                ...
                                                                <hr>
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.item_type')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="text" class="form-control" placeholder="@lang('site.item_type')">
                                                                    </div>
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.gold_caliber')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="number" class="form-control" placeholder="@lang('site.gold_caliber')">
                                                                    </div>
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.amount')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="text" name="amount" class="form-control" placeholder="@lang('site.amount')">
                                                                    </div>
                                                                </div>
                                                                <hr>
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.required')</label>
                                                                    <div class="col-sm-4">
                                                                        <input type="text" class="form-control" placeholder="@lang('site.required')">
                                                                    </div>
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.paid')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="text" name="paid" class="form-control" placeholder="@lang('site.paid')">
                                                                    </div>
                                                                </div>
                                                                <div class="form-group row gutters">
                                                                    ...
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.remain')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="text" name="remain" class="form-control" placeholder="@lang('site.remain')">
                                                                    </div>
                                                                </div>
                                                                <hr>
                                            ...
                                            <div class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.maintenance_doc_edit')</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                        </div>
