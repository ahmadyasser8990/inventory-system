        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.withdraw_amount_of_capital')</li>
                </ol>
            </div>
            <!-- Page header end -->
                            ...
                            <div class="col-xl-3 col-lg-4 col-md-4 col-sm-4 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        ...
                                        <p>@lang('site.withdraw_amount_of_capital')</p>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="row grutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-left mb-3">
                                    <!-- Button add new sale -->
                                    <a href="{{route('dashboard.withdraw-money-of-capital.create')}}" class="btn btn-primary">@lang('site.new_withdraw_amount_of_capital')</a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-light table-sm">
                                        <thead>
                                            <tr>
                                                <th>@lang('site.withdraw_amount_of_capital_no')</th>
                                        ...
                                        <tbody>
                                                ...
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.withdraw_amount_of_capital_info')</h5>
                                                        ...
                                                        <form class="" action="" method="" enctype="">
                                                            ...
                                                            <div class="modal-body">
                                                                ...
                                                                <div class="form-group row gutters">
                                                                    <label class="col-sm-2 col-form-label text-right">@lang('site.withdraw_amount_of_capital_no')</label>
                                                                    <div class="col-sm-2">
                                                                        <input type="number" class="form-control" placeholder="@lang('site.withdraw_amount_of_capital_no')">
                                                                    </div>
                                            ...
                                            <div class="modal fade edit" tabindex="-1" role="dialog" aria-labelledby="showModalLabel" aria-hidden="true">
                                                <div class="modal-dialog modal-xl">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            <h5 class="modal-title" id="showModalLabel">@lang('site.withdraw_amount_of_capital_edit')</h5>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                    <span aria-hidden="true">&times;</span>
                                                                </button>
                                                        </div>
