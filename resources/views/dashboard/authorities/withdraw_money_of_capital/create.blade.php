        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item">@lang('site.withdraw_amount_of_capital')</li>
                        ...
                        <form>
                            <div class="card m-0">
                                <div class="card-header">
                                    <div class="card-title">@lang('site.withdraw_amount_of_capital')</div>
                                </div>
                                <div class="card-body">
                                    ...
                                    <div class="row gutters">
                                        <div class="col-xl-12">
                                            ...
                                            <a href="{{route('dashboard.withdraw-money-of-capital.index')}}" class="btn btn-danger float-right">@lang('site.close')</a>
                                        </div>
                                    </div>
                                    <!-- Row end -->
