        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('dashboard.purchase.index')}}">@lang('site.customer_exchange')</a></li>
                    <li class="breadcrumb-item active">@lang('site.customer_exchange_bill')</li>
                </ol>
            </div>
            <!-- Page header end -->
                                                ...
                                                <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="get_ids"  type="number" id="get_ids" class="form-control form-control-sm selectpicker get_ids"  data-live-search="true">
                                                            <option value=""></option>
                                                            <option value="">10001  - ring</option>
                                                            <option value="">10002 - Nic</option>
                                                    ...
                                                    <table class="table table-bordered table-light table-sm" id="invoice_details">
                                                        ...
                                                        <tfoot>
                                                            <tr>
                                                                ...
                                                                <td colspan="3"><label for="" class="text-bold text-danger total_dimaond_2">0.00</label></td>
                            ...
                            <div class="row gutters pt-2">
                                ...
                                <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="text-right">
                                        <a href="{{route('dashboard.customer-exchange.index')}}" class="btn btn-dark">@lang('site.close')</a>
                                        {{-- <a href="#" class="btn btn-danger">@lang('site.draft_invoice')</a> --}}
                                        <a href="{{route('dashboard.customer-exchange.show')}}" class="btn btn-success">@lang('site.invoice')</a>
                                    </div>
