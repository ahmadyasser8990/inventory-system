        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('dashboard.customer-exchange.index')}}">@lang('site.customer_exchange')</a></li>
                                        ...
                                        <div class="invoice-container" id="print-area">
                                            <div class="invoice-header">
                                                ...
                                                <div class="row gutters">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                        <div class="custom-actions-btns mb-5">
                                                            <a href="{{route('dashboard.customer-exchange.index')}}" class="btn btn-primary">
                                                ...
                                                <div class="row gutters">
                                                    ...
                                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                        <h4 class="text-center">@lang('site.customer_exchange')</h4>
                                                    </div>
                                                            ...
                                                            <table class="table table-bordered table-sm">
                                                                ...
                                                                <tbody>
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            <h5 class="text-danger"><strong>1500 @lang('site.riyal')</strong></h5>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
