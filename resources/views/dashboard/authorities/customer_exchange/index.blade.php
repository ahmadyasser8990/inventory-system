        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.customer_exchange')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row grutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-left mb-3">
                                    <!-- Button add new sale -->
                                    <a href="{{route('dashboard.customer-exchange.create')}}" class="btn btn-primary">@lang('site.new_customer_exchange')</a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                                                    ...
                                                    <div class="task-list">
                                                        <div class="task-block" style="flex-direction: row; padding: 0; border-bottom: 0">
                                                            <ul class="task-actions">
                                                                ...
                                                                <li>
                                                                    <a href="{{route('dashboard.customer-exchange.show')}}" class="star" data-toggle="tooltip" data-placement="top" title="@lang('site.show')">
                                                                        <i class="icon-eye"></i>
                                                                    </a>
                                                                </li>
                                                                <li>
