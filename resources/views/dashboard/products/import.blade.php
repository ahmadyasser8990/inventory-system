        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.import')</li>
                </ol>
            </div>
            <!-- Page header end -->
            ...
            <div class="main-container fixed-height">
                ...
                <div class="fixedBodyScroll">
                    ...
                    <div class="content-wrapper">
                        <br>
                        <form action="{{route('dashboard.products.import.proceed')}}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="row gutters">
                                ...
                                <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                    <div class="mt-4">
                                        <button type="submit" class="btn btn-info"><i class="fa fa-search"></i> @lang('site.submit')</button>
                                    </div>
                                </div>
                                <br>
                                <br>
                                <div class="col-xl-6 col-lg col-md-6 col-sm-6 col-12">
                                    <p>In this page you can import items be careful to the instruction at the below</p>
                                </div>
                            </div>
                        </form>
                        <div class="row gutters">
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                <div class="text-left mb-3">
                                    <!-- Extra large modal -->
                                    <button type="button" class="btn btn-success">@lang('site.download_excel_file')</button>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    <h3>Instruction</h3>
                                    <caption>Follow the instructions carefully before importing the file.</caption>
                                    <table class="table table-bordered table-light table-sm">

                                        <thead>
                                            <tr>
                                                <th>@lang('site.column_no')</th>
                                                <th>@lang('site.column_name')</th>
                                                <th>@lang('site.instruction')</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>{@lang('site.item_no')} <small>(Required)</small></td>
                                                <td><small>(Required)</small></td>
                                            </tr>
                                            <tr>
                                                <td>2</td>
                                                <td colspan="2">{@lang('site.extra_no')}</td>
                                            </tr>
                                            <tr>
                                                <td>3</td>
                                                <td colspan="2">{@lang('site.description')}</td>
                                            </tr>
                                            <tr>
                                                <td>4</td>
                                                <td colspan="2">{@lang('site.gold')}</td>
                                            </tr>
                                            <tr>
                                                <td>5</td>
                                                <td colspan="2">{@lang('site.dimaond')}</td>
                                            </tr>
                                        </tbody>
                                    </table>
                                </div>
