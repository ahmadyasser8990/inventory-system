                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown">
                            <a href="#">
                                ...
                                <span class="menu-text">@lang('site.invoices')</span>
                            </a>
                            <div class="sidebar-submenu">
                                <ul>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.search')</li>
                </ol>
            </div>
            <!-- Page header end -->
            ...
            <div class="main-container fixed-height">
                ...
                <div class="fixedBodyScroll">
                    ...
                    <div class="content-wrapper">
                        <form action="{{route('dashboard.inquiryProducts')}}" method="get">
                            <div class="row gutters">

                                <div class="col-xl-4 col-lg col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                        <label for="">@lang('site.search_by_itemNo')</label>
                                        <input type="text"  class="form-control clear" value="{{ request()->search}}" name="search" placeholder="@lang('site.search_by_itemNo')">
                                    </div>
                                </div>
                            ...
                            <div class="row gutters empty">
                                @if (request()->search == null)
                                    <h2 class="search">@lang('site.search_for_item')</h2>
                                @elseif (!empty($product->id) == null)
                                                ...
                                                <div class="account-settings">
                                                    <div class="user-profile">
                                                        <div class="user-avatar">
                                                            <img src="{{ (!empty($product) && !empty($product->image_path)) ? $product->image_path : ''}}"/>
                                                        </div>
                                                        <h5 class="user-name">@lang('site.item_no') {{ (!empty($product) && !empty($product->id)) ? $product->id : ''}}</h5>
                                                        <h6 class="user-email">@lang('site.category_type') {{ (!empty($product) && !empty($product->category->name)) ? $product->category->name : ''}}</h6>
                                                    </div>
                                                    <div class="setting-links">
                                                        <a href="#">
                                                            <i class=""></i>
                                                            @lang('site.extra_no') {{ (!empty($product) && !empty($product->extra_no)) ? $product->extra_no : ''}}
                                                        </a>
                                                        <a href="#">
                                                            <i class=""></i>
                                                            @lang('site.sale_price')  {{ (!empty($product) && !empty($product->sale_price)) ? $product->sale_price : ''}}
                                                        </a>
                                                        <a href="#">
                                                            <i class=""></i>
                                                            @lang('site.purchase_price') {{ (!empty($product) && !empty($product->purchase_price)) ? $product->purchase_price : ''}}
                                                        </a>
                                                        <a href="#">
                                                            <i class=""></i>
                                                            @lang('site.supplier') {{ (!empty($product) && !empty($product->supplier->name)) ? $product->supplier->name : ''}}
                                                        </a>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div class="col-xl-9 col-lg-9 col-md-12 col-sm-12 col-12">
                                        <div class="card h-100">
                                            <div class="card-header">
                                                <div class="card-title">@lang('site.item_info')</div>
                                            </div>
                                            <div class="card-body">
                                                <div class="row gutters">
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="number" class="form-control" readonly placeholder="@lang('site.gold')" value="{{ (!empty($product) && !empty($product->gold)) ? $product->gold : '0.00'}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('site.dimaond')</label>
                                                            <input type="number" class="form-control" readonly placeholder="@lang('site.dimaond')" value="{{ (!empty($product) && !empty($product->dimaond)) ? $product->dimaond : '0.00'}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('site.baguette')</label>
                                                            <input type="number" class="form-control" readonly placeholder="@lang('site.baguette')" value="{{ (!empty($product) && !empty($product->baguette)) ? $product->baguette : '0.00'}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('site.marquis')</label>
                                                            <input type="number" class="form-control" readonly placeholder="@lang('site.marquis')" value="{{ (!empty($product) && !empty($product->marquis)) ? $product->marquis : '0.00'}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                                        <div class="form-group">
                                                            <label>@lang('site.big_stone')</label>
                                                            <input type="number" class="form-control" readonly placeholder="@lang('site.big_stone')" value="{{ (!empty($product) && !empty($product->big_stone)) ? $product->big_stone : '0.00'}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('site.color')</label>
                                                            <input type="number" class="form-control" readonly placeholder="@lang('site.color')" value="{{ (!empty($product) && !empty($product->color)) ? $product->color : '0.00'}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('site.status')</label>
                                                            <input type="text" class="form-control" readonly placeholder="@lang('site.status')" value="{{ (!empty($product) && !empty($product->status)) ? $product->status : '0.00'}}">
                                                        </div>
                                                        <div class="form-group">
                                                            <label>@lang('site.description')</label>
                                                            <input type="text" class="form-control" readonly placeholder="@lang('site.description')" value="{{ (!empty($product) && !empty($product->description)) ? $product->description : 'لا يوجد وصف'}}">
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="text-right">
                                                            <button type="button" id="btn_clear" name="btn_clear" class="btn btn-dark">@lang('site.clear')</button>
