        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.main_page')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row gutters">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    <label for="docTitle">@lang('site.quick_print') (@lang('site.item_no'))</label>
                                    <input type="text" class="form-control" id="docTitle" placeholder="رقم الصنف">
                                </div>
                                <a href="#" class="btn btn-primary mb-3">@lang('site.print_barcode')</a>
                            </div>
                        </div>
                        <!-- Row end -->
                            ...
                            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card h-280">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.sales')</div>
                                    </div>
                                    <div class="card-body">
                                        ...
                                        <div class="row gutters justify-content-center">
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                                <div class="info-stats m-0">
                                                    ...
                                                    <p class="info-title">@lang('site.sales_processing')</p>
                                            ...
                                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-6">
                                                <div class="info-stats m-0">
                                                    ...
                                                    <p class="info-title">@lang('site.sales_compelted')</p>
                                    ...
                                    <div class="card-body">
                                        <div class="agenda">
                                            <div class="todays-date">
                                                <h5>@lang('site.tasks') - <span class="date" id="todays-date"></span></h5>
                                            </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-6 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card h-320">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.messages')</div>
                                    </div>
                                    <div class="card-body">
                                            ...
                                            <ul class="user-messages">
                                                <li class="clearfix">
                                                    ...
                                                    <div class="delivery-details">
                                                        ...
                                                        <h5>فارس</h5>
                                                        <p>جرد فواتير الشهر 9 يوم الاثنين تمام؟</p>
                                                    </div>
                                                </li>
                                                <li class="clearfix">
                                                    ...
                                                    <div class="delivery-details">
                                                        <span class="badge badge-primary">اليوم</span>
                                                        <h5>محمد يسلم</h5>
                                                        <p>تم تحويل مبلغ 500 ريال لحساب المؤوسسه</p>
                                                    </div>
                                                </li>
                                                <li class="clearfix">
                                                    <div class="customer secondary">LJ</div>
                                                    <div class="delivery-details">
                                                        <span class="badge badge-secondary">امس</span>
                                                        <h5>سعيد سالم</h5>
                                                        <p>لحد يجي المكتب اليوم </p>
                                                    </div>
                                                </li>
                                            </ul>
                                        </div>
                            ...
                            <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6 col-12">
                                <div class="card h-320">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.suppliers')</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="customScroll5">
                                                ...
                                                <div class="top-agent">
                                                    ...
                                                    <div class="agent-details">
                                                        ...
                                                        <div class="agent-score">
                                                            ...
                                                            <div class="points">
                                                                <div class="left">اجمالي المشتريات</div>
                                                                <div class="right">9,800 ريال</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="top-agent">
                                                    ...
                                                    <div class="agent-details">
                                                        ...
                                                        <div class="agent-score">
                                                            <div class="points">
                                                                <div class="left">اجمالي المشتريات</div>
                                                                <div class="right">7,500 ريال</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="top-agent">
                                                    ...
                                                    <div class="agent-details">
                                                        ...
                                                        <div class="agent-score">
                                                            <div class="points">
                                                                <div class="left">اجمالي المشتريات</div>
                                                                <div class="right">4,200 ريال</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="top-agent">
                                                    ...
                                                    <div class="agent-details">
                                                        ...
                                                        <div class="agent-score">
                                                            <div class="points">
                                                                <div class="left">اجمالي المشتريات</div>
                                                                <div class="right">3,800 ريال</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="top-agent">
                                                    ...
                                                    <div class="agent-details">
                                                        ...
                                                        <div class="agent-score">
                                                            <div class="points">
                                                                <div class="left">اجمالي المشتريات</div>
                                                                <div class="right">1,200 ريال</div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
