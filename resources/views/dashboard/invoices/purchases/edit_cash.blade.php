                  ...
                  <div class="row gutters">
                     <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card" id="customer_details">
                                 ...
                                 <div class="row gutters">
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control form-control-sm pickdate"  name="invoice_date" id="invoice_date" required value="{{$purchaseCash->date}}" required>
                                          @error('invoice_date')
                                    ...
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          ...
                                          <select name="payment_method" id="payment_method" class="form-control form-control-sm required">
                                             ...
                                             <option value="cash" @if(!empty($purchaseCash) && $purchaseCash->payment_method == 'cash') selected @endif>@lang('site.cash')</option>
                                             <option value="card" @if(!empty($purchaseCash) && $purchaseCash->payment_method == 'card') selected @endif>Card</option>
                                          </select>
                                    ...
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          ...
                                          <input class="form-control form-control-sm cash"  type="text"  placeholder="" name="supplier_name" value="{{$purchaseCash->supplier_name}}">
                                       </div>
                                    </div>
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          <label for="">@lang('site.phone_no')</label>
                                          <input class="form-control form-control-sm cash"  type="text"  placeholder="" name="supplier_phone_no" value="{{$purchaseCash->supplier_phone}}">
                                       </div>
                                    </div>
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          <label for="">@lang('site.tax_no')</label>
                                          <input class="form-control form-control-sm cash" type="text"  placeholder="" value="{{$purchaseCash->supplier_tax_no}}">
                                       </div>
                                    </div>
                           ...
                           <input type="hidden" name="id" value="{{$purchaseCash->id}}">
                           <div class="card-body" id="getClient">
                              <div class="row gutters">
                                 <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                    <div class="form-group">
                                       <label for="">@lang('site.bill_no')</label>
                                       <input class="form-control form-control-sm" type="text" readonly placeholder="120" value="{{$purchaseCash->id}}">
                                    </div>
                                 </div>
...
<script>
    function submitFormPurchase(event){
     ...
     event.preventDefault();
            $.ajax({
                   url:"/dashboard/purchase/"+id+"?type=cash",
                   type:"PUT",
