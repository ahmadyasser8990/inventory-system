...
<div class="page-wrapper pinned">
   ...
   <div class="page-content">
      ...
      <form  id="purchase_form" action="#" method="POST" enctype="multipart/form-data">
         <!-- Header end -->
         <!-- Page header start -->
                                 ...
                                 <div class="row gutters">
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control form-control-sm pickdate"  name="invoice_date" id="invoice_date" required value="{{$purchaseOrder->date}}" required>
                                          @error('invoice_date')
                                    ...
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          ...
                                          <select name="payment_method" id="payment_method" class="form-control form-control-sm required">
                                             ...
                                             <option value="cash" @if(!empty($purchaseOrder) && $purchaseOrder->payment_method == 'cash') selected @endif>@lang('site.cash')</option>
                                             <option value="card" @if(!empty($purchaseOrder) && $purchaseOrder->payment_method == 'card') selected @endif>Card</option>
                                          </select>
                              ...
                              <div class="row gutters">
                                 <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                    <div class="form-group">
                                       ...
                                       <input class="form-control form-control-sm" type="text" readonly placeholder="120" value="{{$purchaseOrder->id}}">
                                    </div>
                                 </div>
                                 <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                    <div class="form-group">
                                       ...
                                       <select name="supplier_id" type="text" id="supplier_id" class="form-control form-control-sm selectpicker order supplier_id_order">
                                          ...
                                          <option value="{{$supplier->id}}" @if($supplier->id == $purchaseOrder->supplier_id) selected @endif>
                                             {{$supplier->name}}
                                          </option>
                                          @endforeach
                                       </select>
                                 ...
                                 <div class="col-xl-4 col-lg col-md-4 col-sm-4 col-12">
                                    <div class="form-group">
                                       ...
                                       <input class="form-control form-control-sm supplier_name_order order" name="" readonly type="text" placeholder="" value="{{$purchaseOrder->supplier->name ?? null}}">
                                    </div>
                                 </div>
                                 <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                    <div class="form-group">
                                       <label for="">@lang('site.phone_no')</label>
                                       <input class="form-control form-control-sm supplier_phone_no_order order" name="" type="text" readonly placeholder="" value="{{$purchaseOrder->supplier->phone ?? null}}">
                                    </div>
                                 </div>
                                 <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                    <div class="form-group">
                                       <label for="">@lang('site.tax_no')</label>
                                       <input class="form-control form-control-sm supplier_tax_no_order order" name="" type="text" readonly placeholder="" value="{{$purchaseOrder->supplier->tax_no ?? null}}">
                                    </div>
                                 </div>
                              </div>
                              <hr>
                                 ...
                                 <div class="table-responsive">
                                    <table class="table table-bordered table-light table-sm" id="invoice_details">
                                       ...
                                       <tbody id="product-table">
                                        ...
                                        <tr>
   <td>{{$product->id}}<input type='hidden' value='{{$product->id}}' name='added_product_id[]'></td>
   <td>{{$product->item_type}}</td>
   <td>{{$product->extra_no}}</td>
   <td>{{$product->design_no}}</td>
   <td>{{$product->category_id}}</td>
   <td>{{$product->description}}</td>
   <td>{{$product->gold}}<input type='hidden' value="{{$product->gold}}" class='product_gold'></td>
   <td>{{$product->dimaond_1}}<input type='hidden' value="{{$product->dimaond_1}}" class='product_dimaond_1'></td>
   <td>{{$product->baguette}}<input type='hidden' value="{{$product->baguette}}" class='product_baguette'></td>
   <td>{{$product->princess}}<input type='hidden' value="{{$product->princess}}" class='product_princess'></td>
   <td>{{$product->marquis}}<input type='hidden' value="{{$product->marquis}}" class='product_marquis'></td>
   <td>{{$product->big_stone}}<input type='hidden' value="{{$product->big_stone}}" class='product_big_stone'></td>
   <td>{{$product->colored}}<input type='hidden' value="{{$product->colored}}" class='product_colored'></td>     
   <td>{{$product->purchase_price}}<input type='hidden' value="{{$product->purchase_price}}" class='purchase_price'></td>;     
   <td>{{$product->status}}</td>
   <td><button class='btn btn-danger delete_btn' type='button'>Delete</button><input type='hidden' value="{{$product->id}}" class='delete_id'></td>
   </tr>
   @endforeach
                                       </tbody>
                                       <tfoot>
...
<script>
    function submitFormPurchase(event){
     ...
     event.preventDefault();
            $.ajax({
                   url:"/dashboard/purchase/"+id+"?type=order",
                   type:"PUT",
