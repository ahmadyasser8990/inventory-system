                                 ...
                                 <div class="row gutters">
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          ...
                                          <input type="text" class="form-control form-control-sm pickdate"  name="invoice_date" id="invoice_date" required value="{{old('invoice_date')}}" required>
                                          @error('invoice_date')
                                    ...
                                    <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                       <div class="form-group">
                                          ...
                                          <select name="payment_method" id="payment_method" class="form-control form-control-sm required">
                                             ...
                                             <option value="card" @if(!empty(old('payment_method')) && old('payment_method') == 'card') selected @endif>Card</option>
                                          </select>
