        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{route('dashboard.return-secure-bonds.index')}}">@lang('site.return_security_bond')</a></li>
                                        ...
                                        <div class="invoice-container" id="print-area">
                                            <div class="invoice-header">
                                                ...
                                                <div class="row gutters">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                                                        <div class="custom-actions-btns mb-5">
                                                            <a href="{{route('dashboard.return-secure-bonds.index')}}" class="btn btn-primary">
                                                ...
                                                <div class="row gutters">
                                                    ...
                                                    <div class="col-xl-4 col-lg-4 col-md-4 col-sm-4">
                                                        <h4 class="text-center">@lang('site.return_security_bond')</h4>
                                                    </div>
                                                ...
                                                <div class="row gutters">
                                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                        <div class="invoice-details">
                                                            ...
                                                            <address>
                                                                     {{$return_secure_bond->client_name}} <br />
                                                                    {{$return_secure_bond->client_phone}}
                                                                </address>
                                                        </div>
                                                    </div>
                                                    <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12">
                                                ...
                                                <div class="row gutters">
                                                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                        <div class="bill-details">
                                                            ...
                                                            <address>
                                                                    {{$return_secure_bond->id}}<br />
                                                                    {{$return_secure_bond->invoice_date}}
                                                                </address>
                                                        </div>
                                                    </div>
                                                </div>
                                                    ...
                                                    <div class="col-lg-12 col-md-12 col-sm-12">
                                                        <div class="table-responsive">
                                                            <table class="table table-bordered table-sm">
                                                                ...
                                                                <tbody>
                                                                    @foreach ($return_secure_bond_details as $index=>$return_secure_bond_detail )
                                                                        <tr>
                                                                            <td>{{$index + 1}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->id}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->extra_no}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->description}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->category->name}} </td>
                                                                            <td>{{$return_secure_bond_detail->product->purity}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->color}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->gold}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->dimaond_1}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->dimaond_2}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->dimaond_3}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->dimaond_4}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->dimaond_5}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->baguette}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->princess}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->marquis}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->big_stone}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->colored}}</td>
                                                                            <td>{{$return_secure_bond_detail->product->sale_price}}</td>
                                                                        </tr>
                                                                    @endforeach
                                                                    <tr>
                                                                        <td colspan="18">
                                                                        ...
                                                                        <td>
                                                                            <p>
                                                                                {{$return_secure_bond->sub_total}} @lang('site.riyal')<br> {{$return_secure_bond->discount_value}} @lang('site.riyal')
                                                                                <br> {{$return_secure_bond->vat_value}} @lang('site.riyal') <br>
                                                                            </p>
                                                                            <h5 class="text-danger"><strong>{{$return_secure_bond->final_total}} @lang('site.riyal')</strong></h5>
                                                                        </td>
                                                                    </tr>
                                                                </tbody>
                                                            </table>
