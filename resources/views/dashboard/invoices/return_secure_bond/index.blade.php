        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.return_security_bond')</li>
                </ol>
            </div>
            <!-- Page header end -->
                ...
                <div class="fixedBodyScroll">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="text-left mb-3">
                            <a href="{{route('dashboard.return-secure-bonds.create')}}" class="btn btn-primary">@lang('site.new_secure_bond')</a>
                        </div>
                    </div>
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="card">
                            <div class="card-body">
                                @if ($return_secure_bonds->count() > 0)
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-light table-sm">
                                            ...
                                            <tbody>
                                                @foreach ($return_secure_bonds as $index=>$return_secure_bond)
                                                <tr>
                                                    <td>{{ $index + 1 }}</td>
                                                    <td>{{$return_secure_bond->client->name}}</td>
                                                    <td>{{$return_secure_bond->client->phone}}</td>
                                                    <td><span class="text-success">{{$return_secure_bond->sub_total}}</span> @lang('site.riyal')</td>
                                                    <td><span class="text-danger">{{$return_secure_bond->vat_value}}</span> @lang('site.riyal')</td>
                                                    <td>{{$return_secure_bond->final_total}} @lang('site.riyal')</td>
                                                    <td>{{$return_secure_bond->return_secure_bond_details->count()}}</td>
                                                    <td>
                                                        <span class="badge badge-pill badge-danger">@lang('site.return_secure_bond_added')</span>
                                                    </td>
                                                        ...
                                                        <div class="task-list">
                                                            <div class="task-block" style="justify-content: center;flex-direction: row; padding: 0; border-bottom: 0">
                                                                <ul class="task-actions">
                                                                    <li>
                                                                        <a href="{{route('dashboard.return-secure-bonds.show', $return_secure_bond->id)}}" class="star" data-toggle="tooltip" data-placement="top" title="معاينه">
                                                                            <i class="icon-eye"></i>
                                                                        </a>
                                                                    </li>
                                                                    {{-- <li>
