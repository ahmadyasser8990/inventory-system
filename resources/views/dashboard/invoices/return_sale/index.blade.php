        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.return_sale')</li>
                </ol>
            </div>
            <!-- Page header end -->
                ...
                <div class="fixedBodyScroll">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="text-left mb-3">
                            <a href="{{route('dashboard.return-sales.create')}}" class="btn btn-primary">@lang('site.new_return_sale')</a>
                        </div>
                    </div>
                                ...
                                @if ($return_sales->count() > 0)
                                    <div class="table-responsive">
                                        <table class="table table-bordered table-light table-sm">
                                            ...
                                            <tbody>
                                                @foreach ($return_sales as $index=>$return_sale)
                                                <tr>
                                                    <td>{{ $index + 1 }}</td>
                                                    <td>{{$return_sale->client->name}}</td>
                                                    <td>{{$return_sale->client->phone}}</td>
                                                    <td><span class="text-success">{{$return_sale->sub_total}}</span> @lang('site.riyal')</td>
                                                    <td><span class="text-danger">{{$return_sale->vat_value}}</span> @lang('site.riyal')</td>
                                                    <td>{{$return_sale->final_total}} @lang('site.riyal')</td>
                                                    <td>{{$return_sale->return_sale_details->count()}}</td>
                                                    <td>
                                                        <span class="badge badge-pill badge-danger">@lang('site.return_sale_added')</span>
                                                    </td>
