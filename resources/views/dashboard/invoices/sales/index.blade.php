        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.sale_invoices')</li>
                </ol>
            </div>
            <!-- Page header end -->
                        ...
                        <div class="row grutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="text-left mb-3">
                                    <!-- Button add new sale -->
                                    <a href="{{route('dashboard.sales.create')}}" class="btn btn-primary">@lang('site.new_sale')</a>
                                </div>
                            </div>
                        </div>
                        <div class="card">
                                            ...
                                            <tbody>
                                                @foreach ($sales as $index=>$sale)
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <span class="badge badge-pill badge-success">تم البيع</span>
                                                        </td>
                                                        <td class="">
                                                            <div class="task-list">
