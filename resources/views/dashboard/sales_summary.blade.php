        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.sales_summary')</li>
                </ol>
            </div>
            <!-- Page header end -->
                            ...
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <div class="card-title">@lang('site.sales_summary') (@lang('site.print_invoices_by_date_or_invoice_no'))</div>
                                    </div>
                                    <div class="card-body">
                                        <div class="raw">
                                            <!-- Checkbox example current Month -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_current_month">
                                                <label class="custom-control-label" for="checkbox_current_month">@lang('site.current_month')</label>
                                            </div>
                                            <!-- Checkbox example last 3 Months -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_last_3_months">
                                                <label class="custom-control-label" for="checkbox_last_3_months">@lang('site.last_3_months')</label>
                                            </div>
                                            <!-- Checkbox example last 6 Months -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_last_6_months">
                                                <label class="custom-control-label" for="checkbox_last_6_months">@lang('site.last_6_months')</label>
                                            </div>
                                            <!-- Checkbox example select Inoice No -->
                                            <div class="custom-control custom-radio custom-control-inline">
                                                <input type="checkbox" class="custom-control-input" id="checkbox_select_invoice">
                                                <label class="custom-control-label" for="checkbox_select_invoice">@lang('site.select_invoice')</label>
                                            </div>
                                        </div>
                                        <div class="row gutters pt-2">
                                            <div class="col-xl-3 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <input type="text" class="form-control" placeholder="@lang('site.select_invoice')">
                                            </div>
                                        ...
                                        <div class="row gutters pt-2">
                                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                                <div class="text-right">
                                                    <a href="#" class="btn btn-primary mb-3">@lang('site.print_summary')</a>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
