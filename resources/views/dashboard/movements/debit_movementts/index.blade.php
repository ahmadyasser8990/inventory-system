                    ...
                    <ul>
                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    <li class="active">
                                        <a style="background: #8796af94;" href="{{route('dashboard.debit-movement.index')}}">@lang('site.debit_movement')</a>
                                    </li>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.debit_movement')</li>
                </ol>
            </div>
            <!-- Page header end -->
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-2 col-sm-2 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_fixedAssets')</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('site.purchases')</h5>
                                        <div class="table-responsive">

                                            <table class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        <th>@lang('site.purchase_no')</th>
                                                        <th>@lang('site.purchase_date')</th>
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td class="text-left" style="text-align-last: left;" colspan="4">$4500</td>
                                                    </tr>
                                                </tfoot>
                                            </table>
                                        </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('site.expenses')</h5>
                                        <div class="table-responsive">

                                            <table class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        <th>@lang('site.expense_no')</th>
                                                        <th>@lang('site.expense_date')</th>
                                                        <th>@lang('site.account')</th>
                                                        <th>@lang('site.expense_price')</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @for ($i=0; $i<10; $i++)
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('site.fixedAssets')</h5>
                                        <div class="table-responsive">

                                            <table class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        <th>@lang('site.fixedAsset_no')</th>
                                                        <th>@lang('site.fixedAsset_date')</th>
                                                        <th>@lang('site.account')</th>
                                                        <th>@lang('site.fixedAsset_price')</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @for ($i=0; $i<10; $i++)
