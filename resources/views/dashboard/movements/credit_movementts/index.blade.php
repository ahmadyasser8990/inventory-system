                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a style="background: #8796af94;" href="{{route('dashboard.credit-movement.index')}}">@lang('site.credit_movement')</a>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.credit_movement')</li>
                </ol>
            </div>
            <!-- Page header end -->
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_otherCredit')</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('site.sales')</h5>
                                        <div class="table-responsive">

                                            <table class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        <th>@lang('site.sale_no')</th>
                                                        <th>@lang('site.sale_date')</th>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('site.otherCredit')</h5>
                                        <div class="table-responsive">

                                            <table class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        <th>@lang('site.otherCredit_no')</th>
                                                        <th>@lang('site.otherCredit_date')</th>
                                                        <th>@lang('site.account')</th>
                                                        <th>@lang('site.otherCredit_price')</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @for ($i=0; $i<10; $i++)
