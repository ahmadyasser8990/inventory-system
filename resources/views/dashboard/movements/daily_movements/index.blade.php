                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a  style="background: #8796af94;" href="{{route('dashboard.daily-movement.index')}}">@lang('site.daily_movement')</a>
                                    </li>
                                </ul>
                            </div>
                        </li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.daily_movement')</li>
                </ol>
            </div>
            <!-- Page header end -->
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                <div class="form-group">
                                    <label for="">@lang('site.invoice_type')</label>
                                    <select type="text"class="form-control form-control-sm selectpicker" >
                                        <option value="1">@lang('site.purchase')</option>
                                        <option value="1">@lang('site.sale')</option>
                                        <option value="1">@lang('site.offer')</option>
                                        <option value="1">@lang('site.secure_bond')</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                                <div class="form-group">
                                    ...
                                    <select type="text"class="form-control form-control-sm selectpicker" >
                                        ...
                                        <option value="1">Mohammed</option>
                                        <option value="1">Faris</option>
                                        <option value="1">Saeed</option>
                                    </select>
                                </div>
                            </div>
                            <div class="col-xl-2 col-lg col-md-2 col-sm-2 col-12">
                        ...
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('site.daily_movement')</h5>
                                            ...
                                            <table class="table table-bordered table-sm">
                                                ...
                                                <tbody>
                                                    @for ($i=0; $i<10; $i++)
                                                        <tr>
                                                            <td>#00001</td>
                                                            <td>@lang('site.purchase')</td>
                                                            <td>Nacer</td>
                                                            <td>Add new sale invoice</td>
                                                            <td>15/02/2022 12:00pm</td>
                                                            <td>Ahmed</td>
                                                        </tr>
                                                    @endfor
