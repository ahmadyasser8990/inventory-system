                        ...
                        <li class="sidebar-dropdown active">
                            ...
                            <div class="sidebar-submenu">
                                <ul>
                                    ...
                                    <li class="active">
                                        <a style="background: #8796af94;" href="{{route('dashboard.client-balance.index')}}">@lang('site.client_balance')</a>
                                    </li>
                                    <li>
        ...
        <div class="page-content">
            ...
            <div class="page-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">@lang('site.client_balance')</li>
                </ol>
            </div>
            <!-- Page header end -->
                    ...
                    <div class="content-wrapper">
                        ...
                        <div class="row gutters">
                            ...
                            <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col-6">
                                <div class="info-tiles">
                                    ...
                                    <div class="stats-detail">
                                        <h3>14500 ريال</h3>
                                        <p>@lang('site.total_payment_required')</p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row gutters">
                            <div class="col-xl-4 col-lg col-md-4 col-sm-4 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" value="" name="search" placeholder="@lang('site.search_by_clientNo_or_ClientName')">
                                </div>
                            </div>
                        ...
                        <div class="raw">
                            ...
                            <div class="form-inline">
                                <!-- Checkbox debit_amounts -->
                                <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="checkbox_debit_amounts">
                                    <label class="custom-control-label" for="checkbox_debit_amounts">@lang('site.debit_amounts')</label>
                                </div>
                                <!-- Checkbox credit_amounts -->
                                <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="checkbox_credit_amounts">
                                    <label class="custom-control-label" for="checkbox_credit_amounts">@lang('site.credit_amounts')</label>
                                </div>
                                <!-- Checkbox all_balances -->
                                <div class="form-check custom-control custom-radio mb-2 mr-sm-2">
                                    <input type="checkbox" class="custom-control-input" id="checkbox_all_balances">
                                    <label class="custom-control-label" for="checkbox_all_balances">@lang('site.all_balances')</label>
                                </div>
                            </div>
                        </div>
                        <!-- Row start -->
                        <div class="row gutters">
                            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                                ...
                                <div class="card">
                                    <div class="card-body">
                                        <h5 class="card-title">@lang('site.data')</h5>
                                        <div class="table-responsive">

                                            <table class="table table-bordered table-sm">
                                                <thead>
                                                    <tr>
                                                        <th>@lang('site.client_no')</th>
                                                        <th>@lang('site.client_name')</th>
                                                        <th>@lang('site.amounts_reqiured')</th>
                                                        <th>@lang('site.amounts_paid')</th>
                                                        <th>@lang('site.last_amount')</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                    @for ($i=0; $i<10; $i++)
                                                ...
                                                <tfoot>
                                                    <tr>
                                                        <td class="text-left" style="text-align-last: left;" colspan="3">$1500</td>
                                                        <td class="text-left" style="text-align-last: left;" colspan="">$1000</td>
                                                        <td class="text-left" style="text-align-last: left;" colspan="">$500</td>
                                                    </tr>
                                                </tfoot>
                                        ...
                                        <button class="btn btn-primary" type="button"> @lang('site.print')</button>
                                    </div>
                                </div>
